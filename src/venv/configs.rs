...
//!
//! Generates configuration files for type checkers and linters (ty, ruff)
//! to work with ChimeraX bundle development projects.
...
impl<'a> ConfigGenerator<'a> {
    ...
    pub fn new(venv_path: &'a Path, project_root: &'a Path) -> Self {
        Self {
            venv_path,
            project_root,
        }
